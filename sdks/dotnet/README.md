...
app.UseJikida(o =>
{
    o.Token = Environment.GetEnvironmentVariable("JIKIDA_TOKEN");
});
```
...
- Public repo: [github.com/unesLam/jikida](https://github.com/unesLam/jikida/tree/main/packages/sdk-dotnet)
